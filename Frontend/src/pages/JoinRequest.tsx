...
const JoinRequest = () => {
  ...
  const fetchHub = async () => {
    ...
    try {
      ...
      console.log("Hub data fetched:", updatedHub);
    } catch (err) {
      toast({
  ...
  if (isLoading) {
    return <div className="p-6 text-gray-600">Loading hub details...</div>;
  }

  if (!hubData) {
    return <div className="p-6 text-red-600">Hub not found or an error occurred.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        ...
        {/* Hub Card */}
        <Card className="mb-8 overflow-hidden rounded-lg shadow">
          <div 
